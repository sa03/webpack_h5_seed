...
/***/ function(module, exports, __webpack_require__) {
	...
	$(function () {
		...
		var T = {
			...
			checkVCode: function checkVCode() {
				var reg = /\d{4}/;
				var vCode = $("#vCode").val();
				if (!reg.test(vCode)) {
		...
		var V = {
			...
			countVCode: function countVCode(seconds) {
				var timer = seconds;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var lib = {
	    ...
	    /**
	        ...
	        */
	    setParam: function setParam(name, value, causeHistory) {
	    ...
	    setParam2: (function (_setParam2) {
	        function setParam2(_x, _x2, _x3) {
	            return _setParam2.apply(this, arguments);
	        }

	        setParam2.toString = function () {
	            return _setParam2.toString();
	        };
	    ...
	    /**
	        ...
	        * @param {string} name 参数名
	        */
	    removeParam: function removeParam(name, causeHistory) {
	        var hash = document.location.hash.substr(2);
	        var reg = new RegExp("(^|!|&)" + name + "=([^&]*)(&|$)");
	        r = hash.match(reg);
	        if (r) {
	    ...
	    setLocalData: function setLocalData(key, val) {
	        localStorage.setItem(key, JSON.stringify(val));
	    },
	    showLoading: function showLoading(text, timeout, cancelable, delay) {
	        // 超时时间为15s
	    ...
	    showTip: function showTip(msg, timeout) {
	        if (!msg) {
	            return;
	        }
	    ...
	    checkWXAgent: function checkWXAgent() {
	    ...
	    showDialog: function showDialog(msg, callback, title, buttonLabels) {
	        title = title || "提示";
	    ...
	    confirm: function confirm(msg, callback, title, buttonLabels) {
	        title = title || "提示";
